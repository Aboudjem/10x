...
- **contextify** (0.1.0, MIT): Tell every coding agent how your repo works. Then prove it is still true. Writes evidence-backed agent instructions, then checks for drift without a model. One AGENTS.md plus thin pointers, managed-block updates, local shell/Python scripts. Repo: `Aboudjem/contextify`.
