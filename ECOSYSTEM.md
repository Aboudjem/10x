...
| **aws-cost-audit** | 0.1.0 | AWS cost audit. **Read-only** by default: analyzes your live AWS spend and surfaces concrete, gated savings. Built test-first, verified end-to-end on a live account, **zero hardcoded prices** (reads live pricing). | `claude plugin install aws-cost-audit@10x` | [Aboudjem/aws-cost-audit-skill](https://github.com/Aboudjem/aws-cost-audit-skill) | _(skill, no npm)_ | MIT |
